...
all_trees <- lapply(1:50, function(x) plot_SOS(platform = "treetalker", mean_ndvi_values = T, median_ndvi_values = F, tree = x, budburst_percent = F))
all_trees_panel <- gridExtra::marrangeGrob(all_trees, nrow = 5, ncol = 10)
all_trees_panel
